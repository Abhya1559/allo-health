        ...
        <section className="w-full max-w-md space-y-8">
          <div className="space-y-1 text-center">
            ...
            <p className="text-sm text-gray-500">
              Login to access your care dashboard
            </p>
          </div>
          {error && (
      ...
      >
        ...
        <div className="relative z-10 text-center space-y-6 max-w-lg">
          <h1 className="text-4xl font-extrabold tracking-wide leading-snug">
            <span className="inline-block animate-pulse text-pink-300">🔒</span>{" "}
            Secure Login Portal
          </h1>
          <p className="text-lg font-medium text-gray-200">
            Your data is <span className="text-green-400">encrypted</span> &{" "}
            <span className="text-blue-300">protected</span>. Welcome back!
          </p>
          ...
          <div className="mt-6 text-sm opacity-70">
            Built with love for patients and hospitals 💙
          </div>
        </div>
      </motion.div>
    </div>
